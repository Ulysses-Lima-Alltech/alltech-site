...
export function LicensePlanCard({ plan, index = 0 }: LicensePlanCardProps) {
  return (
    <Reveal className="h-full" delay={index * 0.04}>
      <article
        className="group relative h-full overflow-hidden rounded-lg border border-neutral-200/80 bg-white p-4 shadow-[0_10px_30px_rgba(15,23,42,0.04)] transition duration-300 hover:-translate-y-1 hover:border-brand-blue/30 hover:bg-white hover:shadow-[0_18px_42px_rgba(15,23,42,0.07)] md:p-5"
        data-cursor="card"
      >
